-- Allow monetization debugging rows (signals stored in category; does not change reward rules).
...
ALTER TABLE public.user_behavior
  ...
  CHECK (action_type IN ('like', 'view', 'comment', 'follow', 'share', 'monetization_debug'));
